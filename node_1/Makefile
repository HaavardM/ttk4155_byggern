...
SOURCE_FILES := src/main.c src/uart.c src/external_memory.c src/adc.c src/oled.c src/ui.c src/joystick.c src/ui_main_menu.c src/spi.c src/mcp2515.c
...
CC := avr-gcc
CFLAGS := -O -std=c11 -mmcu=$(TARGET_CPU) -I include -Wall
